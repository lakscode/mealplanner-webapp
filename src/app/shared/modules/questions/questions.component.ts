...
export class QuestionsComponent implements OnInit, OnDestroy {
  ...
  uniqueid: any = "";
    ...
    constructor(private router: Router, private dbService: DBService,  private helpService: HelpService, private questionsService: QuestionsService, private el: ElementRef) {
    ...
    ngOnDestroy(): void {
        this.questionsService.remove(this.id);
        this.element.remove();
    }
    ...
    open(): void {
		...
		this.questionsService.add(this);
    }
